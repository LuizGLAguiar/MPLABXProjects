...
start:
    ...
    movwf TRISB ; habilita ((PORTA) and 07Fh), 0 até R3 como entradas
    movwf TRISC ; habilita ((PORTA) and 07Fh), 0 até R3 como entradas
    movlw 0x00 ; dar um clear em W
    movlw 0xE0 ; carrega 11100000 para W
    movwf TRISA ;carrega W em TRISA configurar as saidas ((PORTA) and 07Fh), 0 até como ((PORTA) and 07Fh), 4 como saidas e o resto como entradas
