...
# 713 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic_as_chip_select.inc" 3
# 1 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f886.inc" 1 3
# 47 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f886.inc" 3
INDF equ 0000h
...
EECON2 equ 018Dh
# 2658 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\proc\\pic16f886.inc" 3
...
# 714 "C:/Program Files/Microchip/MPLABX/v6.15/packs/Microchip/PIC16Fxxx_DFP/1.4.149/xc8\\pic\\include\\pic_as_chip_select.inc" 2 3
...
start:
    ...
    movwf TRISA ; Escreve em TRISA para configurar ((PORTA) and 07Fh), 2 e ((PORTA) and 07Fh), 0 como saída, o resto como entradas
...
config_portB:
 ;Estou Definindo o Pull-Up nas próximas 8 linhas
    BANKSEL OPTION_REG
    Banksel WPUB
    BSF WPUB, 0 ;Ativa Pull-Up no pino ((PORTB) and 07Fh), 0 (0)
    BSF WPUB, 1 ;Ativa Pull-Up no pino ((PORTB) and 07Fh), 0 (1)
    BSF WPUB, 2 ;Ativa Pull-Up no pino ((PORTB) and 07Fh), 0 (2)
    BSF WPUB, 3 ;Ativa Pull-Up no pino ((PORTB) and 07Fh), 0 (3)
    ...
    movwf TRISB ; Escreve em TRISA para configurar ((PORTA) and 07Fh), 2 e ((PORTA) and 07Fh), 0 como saída, o resto como entradas
...
config_portC:
    ...
    MOVWF TRISC ; Escreve em TRISA para configurar ((PORTA) and 07Fh), 2 e ((PORTA) and 07Fh), 0 como saída, o resto como entradas
    BANKSEL PORTA
